...
while True:
    ...
    try:
        ...
        updateEngineSound(moving, turning)
        ...
        information_received, sounds_list, engine_volumes = json.loads(
            socket_player.recv(2048).decode().strip()
        )

        updateOtherEngineSound(engine_volumes)
        print(engine_volumes)
