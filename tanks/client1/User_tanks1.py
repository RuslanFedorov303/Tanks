...
from socket import *
import json
from Options1 import loadImages, drawTanks, drawProjectiles, drawDecorations, screen, screen_size
pygame.mixer.init()
...
while True:
    ...
    try:
        ...
        information_received = json.loads(socket_player.recv(2048).decode().strip())
