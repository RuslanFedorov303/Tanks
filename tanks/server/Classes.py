    ...
    def _projectileColideTanks(projectile):
        for tank in projectile.tanks_list:
            ...
            for hitbox in tank.hitboxes_list:
                ...
                offset = (hitbox['rect'].x - projectile.rect.x, hitbox['rect'].y - projectile.rect.y)
                if projectile.mask.overlap(hitbox['mask'], offset):
                    # if hitbox['type'] == 'center': print('center')
                    # if hitbox['type'] == 'forehead': print('forehead')
                    # if hitbox['type'] == 'karma': print('karma')
                    print(hitbox['type'])
                    print(projectile.comand, "->", tank.comand)
