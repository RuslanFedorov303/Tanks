...
class Tank:
    def __init__(self,
        ...
        self.len_vector_of_hitbox_forehead = pygame.Vector2((100, 0))
        self.len_vector_of_hitbox_karma = pygame.Vector2((-100, 0))
        ...
        self.center_hitbox = {
            'original_surfase': center_hitbox_original_surfase,
            'current_surface' : center_hitbox_current_surface,
            'rect': center_hitbox_rect,
            'mask': center_hitbox_mask
        }

        forehead_hitbox_original_surfase = pygame.Surface((100, 100), pygame.SRCALPHA)  # базовая поверхность
        ...
        self.forehead_hitbox = {
            'original_surfase': forehead_hitbox_original_surfase,
            'current_surface': forehead_hitbox_current_surface,
            'rect': forehead_hitbox_rect,
            'mask': forehead_hitbox_mask
        }

        karma_hitbox_original_surfase = pygame.Surface((100, 100), pygame.SRCALPHA)  # базовая поверхность
        karma_hitbox_original_surfase.fill((0, 255, 0))
        ...
        self.karma_hitbox = {
            'original_surfase': karma_hitbox_original_surfase,
    ...
    def _hitboxesUpdate(self):
        self.center_hitbox['current_surfase'] = (
            pygame.transform.rotate(
                self.center_hitbox['original_surfase'],
                self.body_rotate))
        ...
        self.center_hitbox['mask'] = (
            pygame.mask.from_surface(self.center_hitbox['current_surfase']))


        self.forehead_hitbox['current_surfase'] = (
            pygame.transform.rotate(
                self.forehead_hitbox['original_surfase'],
                self.body_rotate))
        ...
        self.forehead_hitbox['mask'] = (
            pygame.mask.from_surface(self.forehead_hitbox['current_surfase']))


        self.karma_hitbox['current_surfase'] = (
            pygame.transform.rotate(
                self.karma_hitbox['original_surfase'],
                self.body_rotate))
        ...
        self.karma_hitbox['mask'] = (
            pygame.mask.from_surface(self.karma_hitbox['current_surfase']))
    ...
    def _tankDraw(self):
        ...
        self.screen.blit(self.center_hitbox['current_surfase'], self.center_hitbox['rect'])
        self.screen.blit(self.forehead_hitbox['current_surfase'], self.forehead_hitbox['rect'])
        self.screen.blit(self.karma_hitbox['current_surfase'], self.karma_hitbox['rect'])
